 ...
 */
public class EditorPaneMenuWidget extends Composite implements EditorPaneMenu, EditorPaneMenuItem.ActionDelegate {
    ...
    @Override
    public void onCloseButtonClicked(@NotNull EditorPaneMenuItem item) {
        popupPanel.hide();
        if (delegate != null) {
            delegate.onItemClose(item);
        }
    }
